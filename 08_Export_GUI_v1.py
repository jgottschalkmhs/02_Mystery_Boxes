...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        # List to hold game stats for export to txt file...
        game_stats_all = [
        ...
        # Add win / loss to list for export
        game_stats_all.append("{} {}".format(win_loss, amount))
        ...
        # Add games played to list for export
        game_stats_all.append(len(game_history))
        ...
        self.export_button = Button(self.export_dismiss_frame, text="Export...",
                                    ...
                                    fg="white",
                                    command=lambda: self.export(game_history, game_stats_all))
    ...
    def export(self, partner, game_history, game_stats_all):
        ...
        self.save_button = Button(self.save_cancel_frame, text="Save",
                                  command=partial(lambda: self.save_history(partner, game_history, game_stats_all)))
